if Rails.env.test?
  ...
  # foursquare
  ENV["FOURSQUARE_CLIENT_ID"] = "1S1HOJBMGJNPAHDCTP2K3MPLAWUUVFULFYJYK3BUPBJ51FJ4"
  ENV["FOURSQUARE_CLIENT_SECRET"] = "AOKUH4CEKJ22AA2OO1QLSXH1OVGYS1OJZ1NYJT3VDCUGEKTK"
end

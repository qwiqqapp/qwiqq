...
task :generate_foursquare_categories_config => :environment do
  ...
  foursquare_category_map = {
    ...
    "College Baseball Diamond" => "sport",
    "College Basketball Court" => "sport",
    "College Cricket Pitch" => "sport",
    "College Football Field" => "sport",
    "College Hockey Rink" => "sport",
    "College Soccer Field" => "sport",
    "College Tennis Court" => "sport",
    "College Track" => "sport",

...
class CouponsController < ApplicationController
  ...
  def paypal_test
    puts "AJAX WORKED"
     @result = HTTParty.post('https://svcs.sandbox.paypal.com/AdaptivePayments/Pay', :senderEmail => "caller_1312486258_biz_api1.gmail.com", :body => {:actionType => "PAY", :currencyCode => "USD", :receiverList => {:receiver => [{:amount => "1.00", :email => "rec1_1312486368_biz@gmail.com"}]}, :returnUrl => "http://www.yahoo.com/", :cancelUrl => "http://www.gizmodo.com/", :ipnNotificationUrl => "http://api.qwiqq.me//api/deals/10463/transactions?buyer_id=13527&sandbox=false", :requestEnvelope => {:errorLanguage => "en_US", :detailLevel => "ReturnAll"}}, :headers => {"X-PAYPAL-SECURITY-USERID" => "caller_1312486258_biz_api1.gmail.com", "X-PAYPAL-SECURITY-PASSWORD" => "1312486294", "X-PAYPAL-SECURITY-SIGNATURE" => "AbtI7HV1xB428VygBUcIhARzxch4AL65.T18CTeylixNNxDZUu0iO87e","X-PAYPAL-APPLICATION-ID" => "APP-80W284485P519543T","X-PAYPAL-REQUEST-DATA-FORMAT" => "JSON", "X-PAYPAL-RESPONSE-DATA-FORMAT" => "JSON"})
